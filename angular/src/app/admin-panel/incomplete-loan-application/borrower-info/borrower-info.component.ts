...
export class BorrowerInfoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.cityListAddress1 != undefined && localStorage.cityListAddress1 != '') {
      this.cityListAddress1 = JSON.parse(localStorage.getItem('cityListAddress1'));
    }
    if (localStorage.cityListAddress2 != undefined && localStorage.cityListAddress2 != '') {
      this.cityListAddress2 = JSON.parse(localStorage.getItem('cityListAddress2'));
    }
    if (localStorage.cityListEmp0 != undefined && localStorage.cityListEmp0 != '') {
      this.cityListEmp0 = JSON.parse(localStorage.getItem('cityListEmp0'));
    }
    if (localStorage.cityListEmp1 != undefined && localStorage.cityListEmp1 != '') {
      this.cityListEmp1 = JSON.parse(localStorage.getItem('cityListEmp1'));
    }
    if (localStorage.cityListEmp2 != undefined && localStorage.cityListEmp2 != '') {
      this.cityListEmp2 = JSON.parse(localStorage.getItem('cityListEmp2'));
    }
    if (localStorage.stateListAddress0 != undefined && localStorage.stateListAddress0 != '') {
      this.stateListAddress0 = JSON.parse(localStorage.getItem('stateListAddress0'));
    }
    if (localStorage.stateListAddress1 != undefined && localStorage.stateListAddress1 != '') {
      this.stateListAddress1 = JSON.parse(localStorage.getItem('stateListAddress1'));
    }
    if (localStorage.stateListAddress2 != undefined && localStorage.stateListAddress2 != '') {
      this.stateListAddress2 = JSON.parse(localStorage.getItem('stateListAddress2'));
    }
    if (localStorage.stateListEmp0 != undefined && localStorage.stateListEmp0 != '') {
      this.stateListEmp0 = JSON.parse(localStorage.getItem('stateListEmp0'));
    }
    if (localStorage.stateListEmp1 != undefined && localStorage.stateListEmp1 != '') {
    ...
    this.borrowService.createMortgageLoanApplication(borrowerModel).subscribe(
      (res: any) => {
        if (res.success == true) {
          ...
          localStorage.setItem("cityListAddress2", JSON.stringify(this.cityListAddress2))
          localStorage.setItem("cityListEmp0", JSON.stringify(this.cityListEmp0))
          localStorage.setItem("cityListEmp1", JSON.stringify(this.cityListEmp1))
          localStorage.setItem("cityListEmp2", JSON.stringify(this.cityListEmp2))
          localStorage.setItem("stateListAddress0", JSON.stringify(this.stateListAddress0))
          localStorage.setItem("stateListAddress1", JSON.stringify(this.stateListAddress1))
          localStorage.setItem("stateListAddress2", JSON.stringify(this.stateListAddress2))
          localStorage.setItem("stateListEmp0", JSON.stringify(this.stateListEmp0))
          localStorage.setItem("stateListEmp1", JSON.stringify(this.stateListEmp1))
          localStorage.setItem("stateListEmp2", JSON.stringify(this.stateListEmp2))
  ...
  showRemoveButton() {
    if (this.borrowerInfo.incomeOtherSources[0].sources.length > 0) {
      var found: any[] = this.borrowerInfo.incomeOtherSources[0].sources.filter((s: any) => s.flgDeletedRow == true);
      if (found.length > 0) {
      ...
      if (this.cityList.length >0) {
        if (section == "Address" && index == 0) {
          ...
          this.cityList.filter((s:any)=>s.stateId == id).forEach((element: any) => {
            ...
            this.cityListAddress1.push({ cityName: element.cityName, id: element.id })
          })
        }
        else if (section == "Address" && index == 2) {
          ...
          this.cityList.filter((s:any)=>s.stateId == id).forEach((element: any) => {
            ...
            this.cityListAddress2.push({ cityName: element.cityName, id: element.id })
          })
        }
        else if (section == "Emp" && index == 0) {
          this.cityListEmp0 = []
          this.cityList.filter((s:any)=>s.stateId == id).forEach((element: any) => {
            ...
            this.cityListEmp0.push({ cityName: element.cityName, id: element.id })
          })
        }
        else if (section == "Emp" && index == 1) {
          this.cityListEmp1 = []
          this.cityList.filter((s:any)=>s.stateId == id).forEach((element: any) => {
            ...
            this.cityListEmp1.push({ cityName: element.cityName, id: element.id })
          })
        }
        else if (section == "Emp" && index == 2) {
          this.cityListEmp2 = []
          this.cityList.filter((s:any)=>s.stateId == id).forEach((element: any) => {
            ...
            this.cityListEmp2.push({ cityName: element.cityName, id: element.id })
          })
        }
      }
  }
  phoneRequired(homePhone, cellPhone, workPhone) {
    ...
    if (homePhone == null || homePhone == undefined || homePhone == "" || homePhone =="(___) ___-____") {
      ...
      if (cellPhone == null || cellPhone == undefined || cellPhone == "" || homePhone =="(___) ___-____") {
        this.flgPhoneRequired = true;
        if (workPhone == null || workPhone == undefined || workPhone == "" || homePhone =="(___) ___-____") {
          this.flgPhoneRequired = true;
        } else {
