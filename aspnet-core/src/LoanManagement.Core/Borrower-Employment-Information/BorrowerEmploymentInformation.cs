...
namespace LoanManagement.Borrower_Information
{
    ...
    {
        [Required] [StringLength(100)] public string EmployersName1 { get; set; }

        [StringLength(100)] public string EmployersAddress1 { get; set; }
        ...
        [StringLength(100)] public string EmployersAddress3 { get; set; }
