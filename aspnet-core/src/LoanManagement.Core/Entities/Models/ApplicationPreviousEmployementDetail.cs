...
{
    public partial class ApplicationPreviousEmployementDetail
    {
        ...
        public virtual City CityId1d33Navigation { get; set; } = null!;
        public virtual Country CountryId1d36Navigation { get; set; } = null!;
        public virtual State StateId1d34Navigation { get; set; } = null!;
    }
}
