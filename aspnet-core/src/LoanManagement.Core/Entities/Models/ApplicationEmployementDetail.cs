...
{
    public partial class ApplicationEmployementDetail
    {
        ...
        public virtual City CityId1b43Navigation { get; set; } = null!;
        public virtual Country CountryId1b46Navigation { get; set; } = null!;
        public virtual State StateId1b44Navigation { get; set; } = null!;
