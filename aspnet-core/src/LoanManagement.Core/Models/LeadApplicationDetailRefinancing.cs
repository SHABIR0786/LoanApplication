...
namespace LoanManagement.Entities.Models
{
    ...
    {
        public LeadApplicationDetailRefinancing()
        {
        ...
        public virtual State PersonalState { get; set; }
        public virtual Country PropertyCountry { get; set; }
        public virtual State PropertyState { get; set; }
