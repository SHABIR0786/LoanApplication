...
namespace LoanManagement.Services.Implementation
{
    public class LeadRefinancingDetailsService : ILeadRefinancingDetailsService
    {
        ...
        {
            var obj = _dbContext.LeadApplicationDetailRefinancings.Where(s => s.Id == id).FirstOrDefault();
            ...
            _dbContext.LeadApplicationDetailRefinancings.Remove(obj);
            _dbContext.SaveChanges();
        ...
        {
            return _dbContext.LeadApplicationDetailRefinancings.Select(d => new UpdateLeadRefinancingDetails()
            {
                Id = d.Id,
        ...
        {
            return _dbContext.LeadApplicationDetailRefinancings.Where(s => s.Id == id).Select(d => new UpdateLeadRefinancingDetails()
            {
                Id = d.Id,
                BirthDate = d.BirthDate,
                CitizenshipId = d.CitizenshipId,
        ...
        public string Update(UpdateLeadRefinancingDetails request)
        {
            ...
            var obj = _dbContext.LeadApplicationDetailRefinancings.Where(s => s.Id == request.Id).FirstOrDefault();
