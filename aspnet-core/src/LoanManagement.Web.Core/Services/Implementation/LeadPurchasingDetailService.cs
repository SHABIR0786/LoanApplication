...
namespace LoanManagement.Services.Implementation
{
    public class LeadPurchasingDetailService : ILeadPurchasingDetailsService
    {
        ...
        public LeadPurchasingDetailService(LoanManagementDbContext dbContext)
        {
        ...
        {
            var obj = _dbContext.LeadApplicationDetailPurchasings.Where(s => s.Id == id).FirstOrDefault();
            ...
            _dbContext.LeadApplicationDetailPurchasings.Remove(obj);
            _dbContext.SaveChanges();
        ...
        {
            return _dbContext.LeadApplicationDetailPurchasings.Select(d => new UpdateLeadPurchasingDetail()
            {
                Id = d.Id,
        ...
        {
            return _dbContext.LeadApplicationDetailPurchasings.Where(s => s.Id == id).Select(d => new UpdateLeadPurchasingDetail()
            {
                Id = d.Id,
                BirthDate = d.BirthDate,
                CitizenshipId = d.CitizenshipId,
        ...
        public string Update(UpdateLeadPurchasingDetail request)
        {
            ...
            var obj = _dbContext.LeadApplicationDetailPurchasings.Where(s => s.Id == request.Id).FirstOrDefault();
