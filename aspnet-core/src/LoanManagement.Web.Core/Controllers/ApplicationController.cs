...
namespace LoanManagement.Controllers
{
	...
	public class ApplicationController : ControllerBase
	{
		...
		[HttpPost]
		[Route("declaration-question/add")]
		public string InsertApplicationDeclarationQuestion([FromBody] AddDeclarationQuestionRequest request)
		{
			return _service.AddApplicationDeclarationQuestion(request);
		}

		[HttpPost]
		[Route("declaration-question/Update")]
		public string UpdateApplicationDeclarationQuestion([FromBody] UpdateDeclarationQuestionRequest request)
		{
			return _service.UpdateApplicationDeclarationQuestion(request);
		}

		[HttpDelete]
		[Route("declaration-question/Delete")]
