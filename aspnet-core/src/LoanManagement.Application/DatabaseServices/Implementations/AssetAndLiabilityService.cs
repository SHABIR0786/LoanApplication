...
{
    public class AssetAndLiabilityService : AbpServiceBase, IAssetAndLiablityService
    {
        private readonly IRepository<AssetAndLiability, long> _repository;

        public AssetAndLiabilityService(IRepository<AssetAndLiability, long> repository)
        {
        ...
        {
            var assetAndLiablity = new AssetAndLiability
            {
                ...
                LifeInsuranceNetFaceAmount = input.LifeInsuranceNetFaceAmount,
        ...
        public async Task<AssetAndLiabilityDto> UpdateAsync(AssetAndLiabilityDto input)
        {
            try
            {
                await _repository.UpdateAsync(input.Id, assetAndLiablity =>
                {
                    ...
                    assetAndLiablity.LifeInsuranceNetFaceAmount = input.LifeInsuranceNetFaceAmount;
                    ...
                    assetAndLiablity.TotalAssets = input.TotalAssets;
                    assetAndLiablity.NetWorth = input.NetWorth;
                    assetAndLiablity.TotalLiabilities = input.TotalLiabilities;
                    assetAndLiablity.AlternateName = input.AlternateName;
                    assetAndLiablity.CreditorName = input.CreditorName;
                    assetAndLiablity.AccountNumber = input.AccountNumber;
