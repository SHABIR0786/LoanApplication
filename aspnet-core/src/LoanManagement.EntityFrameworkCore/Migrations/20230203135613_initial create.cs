    ...
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MortgageApplicationAdditionalEmploymentDetails", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MortgageApplicationEmploymentDetails", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MortgageApplicationPreviousEmploymentDetails", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    others = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    total = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    AdditionalEmploymentDetailId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MortgageApplicationAdditionalEmploymentIncomeDetails", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MortgageApplicationEmploymentIncomeDetails", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    creditLimit = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    isApplied = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    MortgagePropertyAdditionalFinancialInformationId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.MortgagePropertyAdditionalFinancialInformationId,
                        principalTable: "MortgagePropertyAdditionalFinancialInformations",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3396), null, null, null, false, null, null, "Cash deposit on sales contract" },
                    { 2L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3420), null, null, null, false, null, null, "Certificate of Deposit" },
                    { 3L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3422), null, null, null, false, null, null, "Checking Account" },
                    { 4L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3423), null, null, null, false, null, null, "Gifts" },
                    { 5L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3441), null, null, null, false, null, null, "Gift of equity" },
                    { 6L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3443), null, null, null, false, null, null, "Money Market Fund" },
                    { 7L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3445), null, null, null, false, null, null, "Mutual Funds" },
                    { 8L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3446), null, null, null, false, null, null, "Net Proceeds from Real Estate Funds" },
                    { 9L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3497), null, null, null, false, null, null, "Real Estate Owned" },
                    { 10L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3499), null, null, null, false, null, null, "Retirement Funds" },
                    { 11L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3501), null, null, null, false, null, null, "Savings Account" },
                    { 12L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3502), null, null, null, false, null, null, "Stocks & Bonds" },
                    { 13L, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3503), null, null, null, false, null, null, "Trust Account" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3816), null, null, null, "Accessory Unit Income", false, null, null },
                    { 2, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3826), null, null, null, "Alimony/Child Support", false, null, null },
                    { 3, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3828), null, null, null, "Automobile/Expense Account", false, null, null },
                    { 4, new DateTime(2023, 2, 3, 19, 26, 12, 326, DateTimeKind.Local).AddTicks(3830), null, null, null, "Boarder Income", false, null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "MortgagePropertyAdditionalFinancialInformationId");
